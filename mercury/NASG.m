...
figure(1);
  ...
  legend('Experimental values' + string(newline) + '(Vukalovich)','NASG gas phase' + string(newline) + 'theoretical prediction','Location','northeast','Interpreter','latex','FontSize',28);
...
figure(2);
  ...
  legend('Experimental values' + string(newline) + '(Vukalovich)','NASG gas phase' + string(newline) + 'theoretical prediction','Location','southeast','Interpreter','latex','FontSize',28);
  set(gca,'TickLabelInterpreter','latex');
...
figure(5);
  ...
  legend('Experimental values' + string(newline) + '(Vukalovich)','NASG gas phase' + string(newline) + 'theoretical prediction','Location','southwest','Interpreter','latex','FontSize',28);
  set(gca,'TickLabelInterpreter','latex');
...
p_inf_liq_result_all = 29.9238894681130; % taken from p_inf_sol_all_num
LeM_Eq_64_T_P_frac_all = vukalovich_data(:,1) ./ (vukalovich_data(:,2) + p_inf_liq_result_all);
...
for i=1:88
  v_liq_analytic_all(i) = (c_p_liq_minus_c_v_liq_all * vukalovich_data(i,1)) ./ (vukalovich_data(i,2) + p_inf_liq_result_all) + b_liq_all;
...
figure(6);
  ...
  legend('Experimental values' + string(newline) + '(Vukalovich)','NASG liquid phase' + string(newline) + 'theoretical prediction','Location','southeast','Interpreter','latex','FontSize',28);
  set(gca,'TickLabelInterpreter','latex');
...
figure(7);
  ...
  legend('Experimental values' + string(newline) + '(Vukalovich)','NASG liquid phase' + string(newline) + 'theoretical prediction','Location','northeast','Interpreter','latex','FontSize',28);
  set(gca,'TickLabelInterpreter','latex');
%%
...
q_prime_gas_all = (c_p_gas_all - c_p_liq_all) + (c_p_gas_all - c_v_gas_all) .* mean(log(vukalovich_data(:,2)) - (LeM_Eq_41_B_coeff_all + (LeM_Eq_41_E_coeff_all .* vukalovich_data(:,2)))./vukalovich_data(:,1) - LeM_Eq_41_C_coeff_all .* log(vukalovich_data(:,2)) - LeM_Eq_41_D_coeff_all .* log((vukalovich_data(:,2) + p_inf_liq_result_all)));
q_prime_liq_all = 0;
